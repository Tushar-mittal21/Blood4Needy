...
class RequestFAQs extends Component {
    ...
    render() {
        ...
        const Answers = [
            ...
            'No, we don’t charge anything from the requester/patient for arranging the blood donors. If someone asks for any payment on the behalf of Blood4Needy for this purpose, please report to us at bloodrequests@blood4needy.com. Please note that if a donor requests for transport to reach the blood bank, we ask the requestor to arrange the transport or reimburse the cost directly to the donor. In exceptional cases, where it is not possible for the requestor due to financial constraints, Blood4Needy would consider bearing the cost of transportation.',
        ...
        if (this.state.units !== 0 && this.state.pos !== '') {
            axios.post('/api/request/add', request)
                .then(res => {
                    ...
                    this.props.setValues(this.state.pos, this.state.bloodgroup, this.state.type)
            ...
            <div className="request">
                ...
                <form className="requestform" onSubmit={this.onSubmitFinal} >
                    ...
                    <div className="formwrapper">
                        ...
                        <label>Units Required <span className="hindi">(आवश्यक यूनिट्स)</span>&nbsp;</label>
                        <div className="units">
                        ...
                        <label htmlFor="requireddate">Date When Required <span className="hindi">(तारीख)</span>&nbsp;</label>
                    ...
                    <div className="formwrapper">
                        <label htmlFor="patientname">Patient's Full Name <span className="hindi">(रोगी का पूरा नाम)</span>&nbsp;</label>
                        ...
                        <label htmlFor="patientphone">Patient's Contact Number <span className="hindi">(रोगी का संपर्क नंबर)</span>&nbsp;</label>
                        ...
                        <input
                            ...
                            required />
                        <label htmlFor="doctorname">Doctor's Name <span className="hindi">(डॉक्टर का नाम)</span>&nbsp;<span className="colorize">(Optional)</span></label>
                        ...
                        <label htmlFor="reason">Reason/Purpose Details <span className="hindi">(उद्देश्य विवरण)</span>&nbsp;<span className="colorize">(Optional)</span></label>
                    ...
                    <div className="formwrapper">
                        ...
                        <label htmlFor="msgdonors">Message for Donors <span className="hindi">(दाताओं के लिए संदेश)</span>&nbsp;</label>
    ...
    render() {
        ...
        return (
            this.props.auth ? (<div className="requestwrapper">
                <Helmet>
                    <meta name="description" content="Anyone can raise a request if any of your relatives or friends is in need and the hospital has asked you for blood and you are unable to arrange it on your own."></meta>
                    <title>Request</title>
                </Helmet>
